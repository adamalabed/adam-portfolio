      ...
      <footer className="px-6 md:px-10 pb-10 mt-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div className="flex flex-col gap-2">
            ...
            <a href="https://drive.google.com/file/d/1OaWmAl9fyHkYLpL_N-9Ov5r1z2YW2OA4/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-lg md:text-xl font-light hover:opacity-50 transition-opacity flex items-center gap-2 group w-max">
              CV / RESUME
