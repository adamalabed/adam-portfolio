...
const SITE_CONTENT = {
  ru: {
    ...
    hero: {
      title: "Этот сайт – место, где можно увидеть, как я думаю, как принимаю решения, над какими проектами я работал и какие собирал.",
    ...
    cases: [
      {
        ...
        content: {
          ...
          "Моя роль": "Бизнес-аналитик и стратег.\n\n• Проанализировал рынок MENA и конкурентную среду, выявил ключевые драйверы роста.\n• Разработал стратегию выхода на два новых рынка, учитывая локальный спрос и позиционирование.\n• Участвовал в формировании продуктовой стратегии и определил категории для расширения.\n• Проработал элементы клиентского опыта и программы лояльности.\n• Подготовил рекомендации по расширению каналов продаж с фокусом на e-commerce.",
          "Решения": "Основные рекомендации:\n\n• Сфокусированное развитие в наиболее емких категориях.\n• Запуск стратегии выхода на два дополнительных рынка MENA.\n• Адаптация продуктовых линеек под особенности потребителей отдельных стран.\n• Переработка программы лояльности и digital-коммуникаций.\n• Расширение каналов продаж: новые ритейлеры и онлайн-площадки.",
      ...
      },
      {
        ...
        content: {
          ...
          "Моя роль": "Бизнес-аналитик и стратегический консультант.\n\n• Участвовал в сборе и структурировании данных о рынке, конкурентах и потребителях, готовил сравнительные таблицы.\n• Принимал участие в разработке блоков по локализации поставщиков, улучшению логистики и автоматизации производства.\n• Сформировал черновую финансовую модель и помог упаковать результаты в презентацию.",
          "Решения": "Основные рекомендации:\n\n• Локализация производства и работа с российскими поставщиками: партнерства с Автоэлектроникой, Северсталью, Автодизелем (ГАЗ), Борским стекольным заводом и КамАЗом.\n• Расширение продаж и диверсификация продуктов: усиление дилерской сети по регионам РФ, выход на рынки СНГ, фокус на SUV и электромобилях.\n• Улучшение логистики и производства: внедрение автоматизации производственных линий, цифровых систем управления, оптимизация маршрутов.\n• Укрепление маркетинговой стратегии: расширение рекламных кампаний в цифровых каналах, использование онлайн‑видео, запуск программ лояльности.",
          "Результаты": "Ожидаемые эффекты:\n\n• К 2024 году: ожидается увеличение выручки на 10 млрд рублей, рост выпуска на 7 000 автомобилей, снижение издержек на 5%.\n• К 2025 году: планируется рост выручки до 50 млрд рублей, ежегодный рост выпуска на 10 000 автомобилей, сокращение операционных издержек на 10%.\n• К 2026 году: прогнозируется снижение затрат на 15%, рост доли рынка на 5%.\n• К 2027 году: целевой ориентир — достижение общей выручки 140 млрд рублей, полное покрытие инвестиций, экономия на логистике до 20%."
        }
      },
      {
        id: 2,
      ...
      },
      {
        ...
        content: {
          ...
          "Моя роль": "Бизнес-аналитик и стратегический консультант.\n\n• Участвовал в анализе рынка и импортозависимости, структурировал данные о производителях и потребителях.\n• Сопоставлял целевой продукт с аналогами по свойствам и стоимости.\n• Помогал формировать технологическую и экономическую логику проекта (каталитический метод, «зеленый синтез»).\n• Оценивал влияние локализации на себестоимость и окупаемость, участвовал в подготовке выводов по экономике и ESG.",
          "Решения": "Основные рекомендации:\n\n• Локализация производства на основе отечественного сырья и технологий.\n• Разработка и внедрение отечественных катализаторов совместно с университетами и НИИ.\n• Использование «зеленых» технологий синтеза: снижение вредных выбросов, повышение энергоэффективности.\n• Привлечение госпрограмм и частных инвестиций для финансирования R&D и строительства.\n• Формирование долгосрочных контрактов с ключевыми потребителями для устойчивого спроса.",
          "Результаты": "Модель показала, что срок окупаемости проекта может составить 3–5 лет за счет снижения логистических расходов и себестоимости.\n\nОжидаемые эффекты:\n\n• Экономическая выгода: сокращение импортозависимости, создание рабочих мест.\n• Экологический эффект: внедрение энергоэффективных технологий снижает выбросы CO₂ и улучшает соответствие ESG-требованиям, делая проект устойчивым."
        }
      },
      {
        id: 4,
  ...
  en: {
    ...
    hero: {
      title: "This site is a place to see how I think, make decisions, and what projects I've worked on and built.",
      subtitle: "No embellishments, and with details that usually don't fit in a resume."
    },
    sections: {
      context: {
        label: "Context",
    ...
    cases: [
      {
        ...
        content: {
          ...
          "My Role": "Business Analyst and Strategist.\n\n• Analyzed the MENA market and competitive environment, identifying key growth drivers.\n• Developed a strategy for entering two new markets, considering local demand and positioning.\n• Participated in forming the product strategy and identified categories for expansion.\n• Worked on elements of customer experience and loyalty programs.\n• Prepared recommendations for expanding sales channels with a focus on e-commerce.",
          "Solutions": "Main Recommendations:\n\n• Focused development in the most capacious categories.\n• Launch of a strategy to enter two additional MENA markets.\n• Adaptation of product lines to the consumer specifics of individual countries.\n• Overhaul of the loyalty program and digital communications.\n• Expansion of sales channels: new retailers and online platforms.",
      ...
      },
      {
        ...
        content: {
          ...
          "My Role": "Business Analyst and Strategic Consultant.\n\n• Participated in collecting and structuring data on the market, competitors, and consumers, prepared comparative tables.\n• Participated in developing blocks on supplier localization, improving logistics, and production automation.\n• Formed a draft financial model and helped package results into a presentation.",
          "Solutions": "Main Recommendations:\n\n• Localization of production and work with Russian suppliers: partnerships with Avtoelektronika, Severstal, Avtodizel (GAZ), Bor Glassworks, and KAMAZ.\n• Sales expansion and product diversification: strengthening the dealer network across RF regions, entering CIS markets, focus on SUVs and EVs.\n• Improving logistics and production: implementing production line automation, digital management systems, route optimization.\n• Strengthening marketing strategy: expanding advertising campaigns in digital channels, using online video, launching loyalty programs.",
          "Results": "Expected Effects:\n\n• By 2024: expected revenue increase by 10 billion rubles, output growth by 7,000 cars, cost reduction by 5%.\n• By 2025: planned revenue growth to 50 billion rubles, annual output growth by 10,000 cars, operational cost reduction by 10%.\n• By 2026: forecasted cost reduction by 15%, market share growth by 5%.\n• By 2027: target benchmark — achieving total revenue of 140 billion rubles, full investment coverage, logistics savings up to 20%."
        }
      },
      {
        id: 2,
      ...
      },
      {
        ...
        content: {
          ...
          "My Role": "Business Analyst and Strategic Consultant.\n\n• Participated in market and import dependence analysis, structured data on manufacturers and consumers.\n• Compared the target product with analogues in terms of properties and cost.\n• Helped form the technological and economic logic of the project (catalytic method, \"green synthesis\").\n• Evaluated the impact of localization on cost and payback, participated in preparing conclusions on economics and ESG.",
          "Solutions": "Main Recommendations:\n\n• Localization of production based on domestic raw materials and technologies.\n• Development and introduction of domestic catalysts together with universities and research institutes.\n• Use of \"green\" synthesis technologies: reducing harmful emissions, increasing energy efficiency.\n• Attracting state programs and private investment to finance R&D and construction.\n• Forming long-term contracts with key consumers for sustainable demand.",
...
export default function Portfolio() {
  ...
  const [language, setLanguage] = useState('en'); // 'ru' or 'en'
    ...
    <div className="font-sans text-[#1a1a1a] bg-white min-h-screen flex flex-col selection:bg-black selection:text-white">
      ...
      <footer className="px-6 md:px-10 pb-10 mt-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <div className="text-xs opacity-60 tracking-widest uppercase flex items-center gap-1">
            © 2026 <span style={{ fontFamily: "'Ballet', cursive", textTransform: 'none', fontSize: '1.5rem', lineHeight: 1 }}>Nisfaldam</span>
          </div>
        </div>
      </footer>
    </div>
